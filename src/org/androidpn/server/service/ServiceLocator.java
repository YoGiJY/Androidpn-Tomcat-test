...
public class ServiceLocator {
    ...
    private static final String POINT_SERVICE="pointService";
    ...
    /**
     * @author Yao
     * Obtains the point service
     * @return the point service
     */
    public static PointService getPointService(){
    	return (PointService)XmppServer.getInstance().getBean(POINT_SERVICE);
    }
