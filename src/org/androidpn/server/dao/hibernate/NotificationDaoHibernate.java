...
public class NotificationDaoHibernate extends HibernateDaoSupport implements NotificationDao{
     ...
     */
	@SuppressWarnings("unchecked")
	public List<Notification> queryNotificationByUser(String username) {
		// TODO Auto-generated method stub
		Object[] params = new Object[]{username};
        return getHibernateTemplate().find("from Notification n where n.username=? order by n.id desc", params);
	}
